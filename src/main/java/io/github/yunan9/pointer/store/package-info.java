 ...
 *
 * <p>Factory methods such as
 * {@link io.github.yunan9.pointer.store.PointerStore#newPointerStore()},
 * {@link io.github.yunan9.pointer.store.PointerStore#newConcurrentPointerStore()}, and
 * {@link io.github.yunan9.pointer.store.PointerStore#newPointerStore(java.util.Map)}
 * allow callers to select a backing implementation suitable for their concurrency needs.
 */
